...
angular.module('weatherAppApp')
  .factory('weatherDataFactory', function () {
    ...
    var mapApiDataToViewModel = function (apiData, viewModel) {
        ...
        newViewModel.main.temp = Math.round(apiData.main.temp);
        newViewModel.main.temp_min = Math.round(apiData.main.temp_min);
        newViewModel.main.temp_max = Math.round(apiData.main.temp_max);
